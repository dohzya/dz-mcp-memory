...
export class MemoryService {
  ...
  private detectCategory(text: string): string | undefined {
    ...
    if (
      lowerText.includes("api") || lowerText.includes("endpoint") ||
    ...
    if (
      lowerText.includes("database") || lowerText.includes("sql") ||
    ...
    if (
      lowerText.includes("deploy") || lowerText.includes("docker") ||
    ...
    if (
      lowerText.includes("test") || lowerText.includes("spec") ||
